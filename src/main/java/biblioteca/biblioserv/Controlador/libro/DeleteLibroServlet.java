...
@WebServlet(name = "deletelibro", value = "/delete-libro-servlet")
public class DeleteLibroServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Libro libro = daolibro.getLibroByIsbn(isbn);
        ...
        if(daolibro.deleteLibro(libro)){
        System.out.println(json_responce + "fue eliminado con exito");
        impresora.println(json_responce + "fue eliminado con exito");
